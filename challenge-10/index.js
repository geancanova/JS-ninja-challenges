(function(){
  ...
  */
  const isOperatorValid = op => !!operation[op];
  ...
  */
  const calculator = op => {
    ...
    return (num1, num2) =>
      isNaN(num1) || isNaN(num2) ? false : operation[op](num1, num2);
  }
  ...
  */
  const showOperationMessage = (op, num1, num2) => `A operação ${num1} ${op} ${num2} =`;
  ...
  */
  operationSignal = '&';
  const invalidOp = calculator(operationSignal);
