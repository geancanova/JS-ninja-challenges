(function() {
  ...
  */
  ...
  console.log(text.replace(/Manuel Marques de Sousa/, 'Geancarlo Canova'));
  ...
  */
  ...
  console.log(text.replace(/brasileiro/, 'canoense'));
  ...
  */
  ...
  console.log(text.replace(/[a-hD-Z]/g, '0'));
  ...
  */
  ...
  console.log(text.replace(/O Centauro de Luvas/g, (string) => string.toUpperCase()));
  ...
  */
  const regexDate = /(\d{2}) de (junho|julho) de (\d{4})/g;
